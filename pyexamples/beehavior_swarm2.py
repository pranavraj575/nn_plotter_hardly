...
arch = [
    ...
    to_Conv("invisnode",
            offset="(.5,0,0)", to="(flatten-east)",
            width=1, height=1, depth=1,
            opacity=0,
            invisible=True,
            ),
    to_Conv("invisnodeup",
            offset="(0,1,0)", to="(invisnode-west)",
            width=1, height=1, depth=1,
            opacity=0,
            invisible=True,
            ),
    to_Conv("invisnodedown",
            offset="(0,-1,0)", to="(invisnode-west)",
            width=1, height=1, depth=1,
            opacity=0,
            invisible=True,
    ...
    to_connection('flatten-east', "invisnode-west", no_head=True),
    to_connection("invisnode-west", "invisnodeup-west", no_head=True),
    to_connection("invisnode-west", "invisnodedown-west", no_head=True),

    to_ConvConvRelu("linearup", zlabel='~'*8 + str(64),
                    offset="(1,0,0)", to="(invisnodeup-east)",
                    width=len_map(0), height=len_map(0), depth=len_map(64),
                    # caption="{Linear}",
                    ),
    to_connection("invisnodeup-west", "linearup-west"),
    to_Conv("outputup", zlabel=2,
            offset="(1.5,0,0)", to="(linearup-east)",
            width=len_map(0), height=len_map(0), depth=len_map(2),
            caption='\\mbox{Policy Output}',
            # caption="\\hspace{-20 pt}\mbox{Output}",
            ),
    to_connection("linearup-east", "outputup-west"),

    to_ConvConvRelu("lineardown", zlabel='~'*8 + str(64),
                    offset="(1,0,0)", to="(invisnodedown-east)",
                    width=len_map(0), height=len_map(0), depth=len_map(64),
                    caption="{Linear}",
                    ),
    to_connection("invisnodedown-west", "lineardown-west"),
    to_Conv("outputdown", zlabel=1,
            offset="(1.5,0,0)", to="(lineardown-east)",
            width=len_map(0), height=len_map(0), depth=len_map(1),
            caption='\\mbox{Value Output}',
            # caption="\\hspace{-20 pt}\mbox{Output}",
            ),
    to_connection("lineardown-east", "outputdown-west"),

    to_Conv("invis2",
            offset="(1.5,0,0)", to="(outputdown-east)",
            width=1, height=1, depth=1,
            opacity=0,
            invisible=True,
            ),
